  ...
  fr: [
    {
      number: "01",
      title: "ERP Nodus",
      client: "Client privé · Remote · 2025",
      metric: "ERP full-stack",
      metricDetail: "Plateforme métier Next.js + Django + PostgreSQL",
      tags: ["Next.js", "Django", "PostgreSQL", "Backend"],
      image: erpImage,
      link: "#",
    },
    {
      ...
      metric: "UI Fintech",
      metricDetail: "Dashboard analytics et workflows de trading orientés marché",
      tags: ["React", "Fintech", "Dashboard", "UI/UX"],
      image: erpImage,
      link: "#",
    },
    {
      ...
      metric: "Live",
      metricDetail: "Portfolio multilingue avec contact automatisé et volontariat ONG",
      tags: ["React", "Tailwind", "EmailJS", "i18n"],
      image: erpImage,
      link: "#",
    },
    {
      ...
      client: "Entreprise locale · Fév 2025 - Avr 2026",
      metric: "1 an 3 mois",
...
export const Projects = () => {
  ...
  const labels = {
    ...
    fr: {
      ...
      title: "Produits web, mobile et fintech — livrés avec un vrai impact.",
